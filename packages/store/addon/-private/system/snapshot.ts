...
function relationshipsFor(instance: Snapshot): Relationships {
  ...
  // TODO this case is not safe but it is the assumption of the current
...
export default class Snapshot {
  private __attributes: Dict<any> | null = null;
  ...
  */
  eachAttribute(callback: (key: string, meta: AttributeSchema) => void, binding?: any): void {
    if (CUSTOM_MODEL_CLASS) {
  ...
  /**
    ...
    @param {Object} [binding] the value to which the callback's `this` should be bound
  */
  eachRelationship(callback: (key: string, meta: RelationshipSchema) => void, binding?: any): void {
    if (CUSTOM_MODEL_CLASS) {
